...
| **Depth of Reasoning** | **Infinite ($k 	o \infty$):** Assumes complete mutual hyper-rationality ("I know that you know..."). | **Bounded Level-$k$ ($k pprox 1	ext{--}2$):** Mirrors empirical human cognitive limits in static setups. |
...
```
  [ Initial State: S₀ ] ──────► [ Universal Physics / Rules: R ] ──────► [ State: S₁ ] ──► ...
